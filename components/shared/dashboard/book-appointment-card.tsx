...
export const BookAppointmentCard = () => {
  return (
    <div className="relative w-full md:w-[48%] xl:w-[32%] 3xl:w-[326px] max-w-full md:max-w-[48%] xl:max-w-[32%] 3xl:max-w-[326px] h-[370px] bg-no-repeat bg-cover bg-[url(../components/assets/book-appointment.png)] rounded-2xl">
