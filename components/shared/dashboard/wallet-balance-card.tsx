...
export const WalletBalanceCard = () => {
  return (
    <div className="relative p-6 w-full md:w-[48%] xl:w-[32%] 3xl:w-[283px] max-w-full md:max-w-[48%] xl:max-w-[32%] 3xl:max-w-[283px] h-[370px] rounded-2xl bg-text-bg-3 grid gap-y-1 content-start">
